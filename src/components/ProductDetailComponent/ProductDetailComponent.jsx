  ...
  return (
    ...
    <Row style={{ padding: '16px', background: '#fff', borderRadius: '4px' }}>
        <Col span={10} style={{ borderRight: '1px solid #e5e5e5', paddingRight: '8px' }}>
            <Image style={{ width:'300px' ,height:'350px',marginLeft:'60px'}} src={productDetails?.image} alt="image prodcut" preview={false} />
            <Row style={{ paddingTop: '10px', justifyContent: 'space-between' }}>
                <WrapperStyleColImage span={4} sty>
                    <WrapperStyleImageSmall src={imageProductSmail} alt="image small" preview={false} />
                ...
                <Col span={14} style={{ paddingLeft: '10px' }}>
                    ...
                    <div style={{ margin: '10px 0 20px', padding: '10px 0', borderTop: '1px solid #e5e5e5', borderBottom: '1px solid #e5e5e5' }}>
                        ...
                        <WrapperQualityProduct>
                            ...
                            <WrapperInputNumber onChange={onChange} defaultValue={1} min={1} value={numProduct} size="small" />
